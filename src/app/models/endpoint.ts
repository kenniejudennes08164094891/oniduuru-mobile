export const endpoints = {
  ...
  createTalentSecurityQuestions: 'login/v1/auth/create-talent-security-questions',
  createScouterSecurityQuestions:'login/v1/auth/create-scouter-security-questions',
  ...
  validateTalentSecurityQuestion: 'login/v1/auth/validate-talent-security-questions',
  validateScouterSecurityQuestions: 'login/v1/auth/validate-scouter-security-questions',
  updateTalentSecurityQuestions: 'login/v1/auth/update-talent-security-questions',
  updateScouterSecurityQuestions: 'login/v1/auth/update-scouter-security-questions',
  ...
  scouterMarketWithTalent: 'dashboard/v1/dashboard-statistics/get-scouter-talent-stats',
