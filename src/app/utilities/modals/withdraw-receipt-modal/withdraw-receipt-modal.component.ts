// withdraw-receipt-modal.component.ts
import { Component, OnInit, Input } from '@angular/core';
import { ModalController } from '@ionic/angular';

@Component({
  selector: 'app-withdraw-receipt-modal',
  templateUrl: './withdraw-receipt-modal.component.html',
  styleUrls: ['./withdraw-receipt-modal.component.scss'],
  standalone: false,
})
export class WithdrawReceiptModalComponent implements OnInit {
  @Input() amount!: number;
