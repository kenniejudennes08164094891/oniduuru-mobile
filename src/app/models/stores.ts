...
{  path: 'talent-details', ionIcon: 'person-circle-outline' , routerLink:'/talent/create-account/talent-details'},
{  path: 'talent-other-details', ionIcon: 'list-outline', routerLink:'/talent/create-account/talent-other-details' },
